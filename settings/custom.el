(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (expand-region typescript-mode helm-tramp clj-refactor clojure-mode-extra-font-locking cider go-mode groovy-mode yaml-mode docker-tramp dockerfile-mode yasnippet-snippets yasnippet enh-ruby-mode coffee-mode helm-swoop markdown-mode org-bullets helm-flyspell fireplace smartparens rjsx-mode undo-tree multiple-cursors magit restclient neotree direx emmet-mode helm-ag helm-projectile avy web-mode projectile-rails solarized-theme god-mode helm helm-ebdb))))
(custom-set-faces
